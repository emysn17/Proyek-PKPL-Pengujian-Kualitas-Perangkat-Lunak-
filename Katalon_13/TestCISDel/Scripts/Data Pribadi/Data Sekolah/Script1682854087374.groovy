...
WebUI.click(findTestObject('Object Repository/Page_11321023 Emy Sonia Sinambela/span_Home_fa fa-gear'))

WebUI.click(findTestObject('Object Repository/Page_11321023 Emy Sonia Sinambela/a_Edit Data Induk'))

WebUI.setText(findTestObject('Object Repository/Page_Edit 11321023 Emy Sonia Sinambela/input_Asal Sekolah_asal_sekolah_id-fake'), 
    'SMAN 1 SBB')
